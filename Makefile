...
games: spring_challenge_2022 winter_shallenger_2022

spring_challenge_2022: 
	cd game/spring_challenge_2022 && \
	python3 -m pytest -s tests --cov=src

winter_shallenger_2022: 
	cd game/winter_shallenger_2022 && \
	python3 -m pytest -s tests --cov=src

merge: merge_spring_challenge_2022 merge_winter_shallenger_2022
